...
const deleteItem = (req, res, next) => {
    try {
        ...
        const newMessages = messages.filter((el) => el.id !== itemID );

        newMessages.forEach((el, index) => el.id = index);
...
export { formGet, formPost, formGetID, updateItemGet, updateItemPost, deleteItem };